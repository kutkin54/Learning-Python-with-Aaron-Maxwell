...
def london_point():
    return Location(51.50853, -0.076132)


def dict_default_london():
    return defaultdict(london_point)
...
def fetch_first(dict):
    return dict.popitem(False)


def fetch_last(dict):
    return dict.popitem(True)
