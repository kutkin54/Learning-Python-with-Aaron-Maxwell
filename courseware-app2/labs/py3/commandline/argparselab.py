...
parser1 = argparse.ArgumentParser(description='parser1')
parser1.add_argument('filename')
parser1.add_argument('destination')

parser2 = argparse.ArgumentParser(description='parser2')
parser2.add_argument('filename')
parser2.add_argument('--type', default='text', type=str)


parser3 = argparse.ArgumentParser(description='parser3')
